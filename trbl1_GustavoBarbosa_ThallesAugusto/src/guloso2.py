# Algoritmo de Busca Gulosa para encontrar o caminho mais curto em um grafo
...
def busca_gulosa(grafo, heuristica, inicio, objetivo):
    ...
    fila = PriorityQueue()
    fila.put((heuristica[inicio], inicio))  # (heurística, nó)
    ...
    while not fila.empty():
        ...
        cont += 1
        _, atual = fila.get()  # Pega o nó com menor heurística
        print('Atual: ',atual, _)
        #print(_)
        caminho.append(atual)

        if atual == objetivo:
            return caminho  # Retorna o caminho até o objetivo
        ...
        for vizinho in grafo[atual]:
            ...
            if vizinho not in visitados:
                fila.put((heuristica[vizinho], vizinho))
...
inicio = "Arad"
objetivo = "Bucharest"
caminho = busca_gulosa(grafo_romenia, heuristica_bucharest, inicio, objetivo)
